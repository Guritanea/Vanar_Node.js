...
module.exports.menu=[ 
         ...
         // new Item(3.,"Bread", 5.00,  "LEI"),
          ...
          new Food(4, "Salad", new Price(20, "MDL"), new Measurement(350,"gr")),
          new Food(5, "Soup", new Price(25, "MDL"), new Measurement(400,"gr")),
          new Food(6, "Nuggets", new Price(20, "MDL"), new Measurement(350,"gr")) 
        ]
